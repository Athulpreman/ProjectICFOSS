...
if submit:
	...
	st.write(NoMajorVessels)
	result = classifier.predict([[age,gender,ChestPainType,BloodPressure,Cholestrol,BloodSugar,ECG,MaximumHeartRate,Exercise,NoMajorVessels]])
	if result ==0:
		st.markdown("I am very sorry... ***It seems you will have heart attack*** :cry:")
		st.warning("Take required precautions as soon as possible. Visit the following site for more details.    https://www.medicinenet.com/heart_attack_and_atherosclerosis_prevention/article.htm")
